/* eslint-disable no-underscore-dangle,camelcase,no-multi-assign,no-param-reassign,brace-style,no-undef,prefer-rest-params,no-void,max-len,no-mixed-operators */
...
/* 0 */
	/** */ function (module, exports, __webpack_require__) {
		const _angularjsDropdownMultiselect = __webpack_require__(1);

		const _angularjsDropdownMultiselect2 = _interopRequireDefault(_angularjsDropdownMultiselect);
...
/* 1 */
	/** */ function (module, exports, __webpack_require__) {
		...
		const _angularjsDropdownMultiselect = __webpack_require__(2);
	...
	*/
		...
		function dropdownMultiselectController($scope, $element, $filter, $document) {
			...
			function deselectAll() {
				const dontSendEvent = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
			...
			function setSelectedItem(option) {
				const dontRemove = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
				const fireSelectionChange = arguments[2];
